...
ALTER TABLE  `{$this->_db->database}`.`payroll_templates_earnings` ADD  `template_id` int(20) NOT NULL   ;
ALTER TABLE  `{$this->_db->database}`.`payroll_templates_earnings` ADD  `earning_id` int(20) NOT NULL   ;
ALTER TABLE  `{$this->_db->database}`.`payroll_templates_earnings` ADD  `order` int(2) NOT NULL   DEFAULT '0';
...
// ------------------------------ End Field: order --------------------------------------
	...
	public function add_table_column($field_name) {
		$column = array(
			'template_id' => "ALTER TABLE  `{$this->_db->database}`.`payroll_templates_earnings` ADD  `template_id` int(20) NOT NULL   ;",
			'earning_id' => "ALTER TABLE  `{$this->_db->database}`.`payroll_templates_earnings` ADD  `earning_id` int(20) NOT NULL   ;",
			'order' => "ALTER TABLE  `{$this->_db->database}`.`payroll_templates_earnings` ADD  `order` int(2) NOT NULL   DEFAULT '0';",
		);
