...
class Payroll_employees_deductions_model extends MY_Model {
	...
	*/
	...
	function __construct($short_name=NULL, $db_config=NULL) {
		...
		$this->_fields = array("id","payroll_id","name_id","deduction_id","entry_id","amount","notes","manual","pe_id");
		$this->_required = array("payroll_id","name_id","deduction_id","entry_id","amount","manual","pe_id");
