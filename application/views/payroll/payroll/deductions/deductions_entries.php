...
foreach($deductions as $deduction) {  ?>
  ...
  <a data-target="#ajaxModal" data-title="Edit Entry" class="list-group-item ajax-modal-inner" href="<?php echo site_url("payroll_deductions/edit/{$deduction->id}/ajax") . "?next=" . $this->input->get('next'); ?>">
    <h4 class="list-group-item-heading"><?php echo number_format($deduction->amount,2); ?></h4>
