          ...
          <table class="table table-default table-hover">
            ...
            <?php foreach($employees as $employee) { ?>
              ...
              <?php if( hasAccess('employees', 'employees', 'edit') ) { ?>
                ...
                <button type="button" class="btn btn-info btn-xs ajax-modal" data-toggle="modal" data-target="#ajaxModal" data-title="Configure Employee" data-url="<?php echo site_url("employees/config/{$employee->name_id}/ajax"); ?>" data-hide_footer="1">Config</button>
