...
<?php if( hasAccess('employees', 'employees', 'add') ) { ?>
  <button type="button" class="btn btn-success btn-xs pull-right ajax-modal" data-toggle="modal" data-target="#ajaxModal" data-title="Add Basic Salary" data-url="<?php echo site_url("employees_salaries/add/{$employee->name_id}/ajax") . "?next=" . uri_string(); ?>" style="margin-right: 5px">Add Basic Salary</button>
<?php } ?>
...
switch( $salary->rate_per ) {
  ...
  break;
              ...
              <?php if( hasAccess('employees', 'employees', 'edit') ) { ?>
                ...
                <button type="button" class="btn btn-info btn-xs ajax-modal" data-toggle="modal" data-target="#ajaxModal" data-title="Edit Basic Salary" data-url="<?php echo site_url("employees_salaries/edit/{$salary->id}/ajax") . "?next=" . uri_string(); ?>">Edit</button>
