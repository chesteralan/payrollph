...
<?php endif; ?>
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <?php foreach($earnings as $earn) { ?>
                <option value="<?php echo $earn->id; ?>"<?php echo ($earning->earning_id==$earn->id) ? ' SELECTED' : ''; ?>><?php echo $earn->name; ?></option>
            <?php } ?>
            </select>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
              <div class="form-group">
                <p><label><input name="repeat" type="checkbox" value="1"<?php echo ($earning->repeat) ? ' CHECKED' : ''; ?>> Repeat per Payroll</label></p>
