          ...
          <table class="table table-default table-hover">
            ...
            <?php foreach($items as $item) { ?>
              <tr id="employee-group-<?php echo $item->id; ?>">
                ...
                <?php } ?>
                <td class="text-right">
                  <button type="button" class="btn btn-warning btn-xs ajax-modal" data-toggle="modal" data-target="#ajaxModal" data-title="Edit Benefit" data-url="<?php echo site_url("employees_benefits/edit/{$item->id}/ajax") . "?next=" . uri_string(); ?>">Edit</button>

                  <button type="button" class="btn btn-success btn-xs ajax-modal" data-toggle="modal" data-target="#ajaxModal" data-title="Benefit Entries" data-url="<?php echo site_url("employees_benefits/entries/{$item->id}/ajax") . "?next=" . uri_string(); ?>">Entries</button>
