...
<?php if( $group->employees_count==0 ) { ?>
                <a class="btn btn-danger btn-xs confirm_remove" href="<?php echo site_url("employees_groups/delete/{$group->id}"); ?>" data-target="#employee-group-<?php echo $group->id; ?>">Delete</a>
<?php } ?>
                </td>
              <?php } ?>
              </tr>
