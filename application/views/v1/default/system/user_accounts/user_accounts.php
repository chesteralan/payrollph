	    		...
	    		<table class="table table-default">
	    			...
	    			<?php foreach($users as $user) { ?>
	    				...
	    				<?php if( hasAccess('system', 'users', 'edit') ) { ?>
	    					...
	    					<button type="button" class="btn btn-warning btn-xs ajax-modal" data-toggle="modal" data-target="#ajaxModal" data-title="Edit User : <?php echo $user->name; ?>" data-url="<?php echo site_url("system_users/edit/{$user->id}/ajax") . "?next=" . uri_string(); ?>">Edit</button>

	    					<button type="button" class="btn btn-primary btn-xs ajax-modal" data-toggle="modal" data-target="#ajaxModal" data-title="Companies : <?php echo $user->name; ?>" data-url="<?php echo site_url("system_users/companies/{$user->id}/ajax") . "?next=" . uri_string(); ?>">Companies</button>
