...
Employee No: <strong class="allcaps employee-name underlined bold"><?php echo $employee->employee_id; ?></strong>
    </td>
  </tr>
</table>
...
<tr>
  <td class="text-left"><strong>Add:</strong> Leave Benefits (<?php  echo $days_benefits; ?>)</td>
