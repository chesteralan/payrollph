...
<a href="<?php echo payroll_url("employees_earnings/entries/{$earning->entry_id}/ajax"); ?>" data-dismiss="modal" class="btn btn-success btn-xs ajax-modal-inner" data-title="Related Entries" data-hide_footer="1">View Related Entries</a>
<?php } ?>
<a href="<?php echo payroll_url("payroll_earnings/delete/{$earning->id}"); ?>" class="btn btn-danger btn-xs confirm">Delete this entry</a>
